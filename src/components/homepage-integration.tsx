...
interface HomepageIntegrationProps {
  onEnterApp: () => void;
}

export function HomepageIntegration({ onEnterApp }: HomepageIntegrationProps) {
    ...
    <div className="relative h-screen w-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-[9999]">
        ...
        <div className="mb-8">
          ...
          >
            {isTransitioning ? 'EXPLODING...' : 'ENTER APP'}
          </button>
        </div>
